...
[![Build status](https://ci.appveyor.com/api/projects/status/7i1h18cu4ooo9rl5/branch/main?svg=true)](https://ci.appveyor.com/project/Genius-Society/wifi-sharer/branch/main)
...
The software of Wi-Fi hotspot for Windows 7-10 laptops, we also have Qt version called [QSharer](https://github.com/Genius-Society/wifi_sharer/tree/qt)
...
## 组建 Build
 ...
 2. 安装 VS2010+ (Install Microsoft Visual Studio 2010+)
 3. 以管理员身份打开 _Sharer.sln_ 工程 (Open _Sharer.sln_ as admin)
 4. 点击组建按钮 (Perform _build_ action)